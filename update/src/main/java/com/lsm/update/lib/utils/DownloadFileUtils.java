package com.lsm.update.lib.utils;
...
import com.lsm.update.lib.http.ProgressResponseBody;
...
public class DownloadFileUtils {
     ...
     */
    private BaseFileProgressCallback defaultFileProgressCallback = new BaseFileProgressCallback() {
     ...
     */
    public void execute(BaseFileProgressCallback fileProgressCallback) {
    ...
    private void startDonwload() {
        ...
        //文件回调
        final BaseFileProgressCallback fileProgressCallback = downloadModel.getFileProgressCallback();
